...
const base: ManualInputs = {
  ...
  stopBp: '12.5', leverage: '3', sizePct: '10',
  useLadder: true, rungs: [{ bp: '25', percent: '40' }, { bp: '50', percent: '30' }, { bp: '75', percent: '30' }],
  singleTpBp: '50', breakEven: true, cancelSecs: '120',
}
...
for (const change of [
  ...
  { rungs: [{ bp: '', percent: '50' }] }, { rungs: [{ bp: '25', percent: '101' }] },
